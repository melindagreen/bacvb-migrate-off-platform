...
* `utilities.php` contains reusable utility functions **specific to the child theme**. Globally relevant utility functions should be placed within Madden Madre's utility file instead.