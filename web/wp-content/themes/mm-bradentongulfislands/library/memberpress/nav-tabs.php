...
<form class="mepr-account-form" method="post" enctype="multipart/form-data" action="">
    ...
    <textarea name="eventastic_description" id="eventastic_description"></textarea>

    <div class="mepr-account-form__col-2">
        <!-- Business Name -->
        <label for="eventastic_business_name">Business Name:</label>
        <input type="text" name="eventastic_business_name" id="eventastic_business_name" value="">

        <!-- Website Link -->
        <label for="eventastic_website_link">Website Link:</label>
        <input type="url" name="eventastic_website_link" id="eventastic_website_link" value="">
    </div>

    <div class="mepr-account-form__col-2">
        <!-- Phone Number -->
        <label for="eventastic_phone_number">Phone Number:</label><br>
        <input type="tel" name="eventastic_phone_number" id="eventastic_phone_number" value=""><br>

        <!-- Contact Email for Visitors -->
        <label for="eventastic_contact_email_for_visitors">Contact Email for Visitors:</label><br>
        <input type="email" name="eventastic_contact_email_for_visitors" id="eventastic_contact_email_for_visitors" value=""><br>
    </div>
    ...
    <textarea name="eventastic_hours_description" id="eventastic_hours_description"></textarea>
    ...
    <div class="mepr-account-form__col-2">
        ...
        <input type="text" name="eventastic_address_1" id="eventastic_address_1" value="">
    </div>
    <div class="mepr-account-form__col-2">
        <!-- Address Line 2 -->
        <label for="eventastic_address_2">Address Line 2:</label><br>
        <input type="text" name="eventastic_address_2" id="eventastic_address_2" value="">
    </div>

    <div class="mepr-account-form__col-3">
        <!-- City -->
        <label for="eventastic_city">City:</label><br>
        <input type="text" name="eventastic_city" id="eventastic_city" value="">
    </div>
    <div class="mepr-account-form__col-3">
        <!-- Zip Code -->
        <label for="eventastic_zip">Zip Code:</label><br>
        <input type="text" name="eventastic_zip" id="eventastic_zip" value="">
    </div>
    <div class="mepr-account-form__col-3">
        <!-- State -->
        <label for="eventastic_state">State:</label><br>
        <input type="text" name="eventastic_state" id="eventastic_state" value="">
    </div>
    ...
    <div class="mepr-account-form__col-2">
        ...
        <input type="url" name="eventastic_facebook" id="eventastic_facebook" value="">

        <!-- Instagram -->
        <label for="eventastic_instagram">Instagram</label><br>
        <input type="url" name="eventastic_instagram" id="eventastic_instagram" value="">
    </div>

    <div class="mepr-account-form__col-2">
        <!-- Twitter -->
        <label for="eventastic_twitter">Twitter</label><br>
        <input type="url" name="eventastic_twitter" id="eventastic_twitter" value="">
    </div>
    ...
    <div class="mepr-account-form__col-2">
        ...
        <input type="number" name="eventastic_price" id="eventastic_price" value="" step=".01">
    </div>
    <div class="mepr-account-form__col-2">
        <!-- Price Varies -->
        <label for="eventastic_price_varies">Price Varies:</label><br>
        <input type="checkbox" name="eventastic_price_varies" id="eventastic_price_varies" value="varies">
    </div>

     <!-- Tickets -->
    <label for="eventastic_city">Tickets Url:</label><br>
    <input type="url" name="eventastic_ticket_link" id="eventastic_ticket_link" value="">
    ...
    <div class="mepr-account-form__col-2">
        ...
        <input type="date" name="eventastic_start_date" id="eventastic_start_date" value="">
    </div>
    <div class="mepr-account-form__col-2">
        <!-- End Date -->
        <label for="eventastic_end_date">End Date:</label><br>
        <input type="date" name="eventastic_end_date" id="eventastic_end_date" value="">
    </div>
    ...
    <input type="checkbox" name="eventastic_event_all_day" id="eventastic_event_all_day" value="true">

    <div class="mepr-account-form__col-2">
        <!-- Start Time -->
        <label for="eventastic_start_time">Start Time:</label><br>
        <input type="time" name="eventastic_start_time" id="eventastic_start_time" value="">
    </div>
    <div class="mepr-account-form__col-2">
        <!-- End Time -->
        <label for="eventastic_end_date">End Time:</label><br>
        <input type="time" name="eventastic_end_time" id="eventastic_end_time" value="">
    </div>
