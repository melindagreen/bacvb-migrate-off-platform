...
function render_block( $attrs, $content ) {
  $html = "<section class='mm-content-slider'>
    ...
    <div class='swiper-button-prev'><img src='".get_stylesheet_directory_uri()."/assets/images/prev.png' /></div>
    <div class='swiper-button-next'><img src='".get_stylesheet_directory_uri()."/assets/images/next.png' /></div>
  </section>";
  return $html;
}