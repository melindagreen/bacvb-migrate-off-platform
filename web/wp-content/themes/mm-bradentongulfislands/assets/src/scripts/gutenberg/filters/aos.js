...
const gutenbergAOSControls = createHigherOrderComponent((BlockEdit) => {
	...
	return (props) => {
		...
		const { gutenbergUseAOS, gutenbergAOSAnimation } = attributes;
						...
						<PanelBody title={__("AOS Settings", "gutenberg-aos")}>
							<PanelRow>
								<ToggleControl
									...
									onChange={() =>
										setAttributes({ gutenbergUseAOS: !gutenbergUseAOS })
									}
									help={
										!!gutenbergUseAOS
											? __(
													"Animate Element when it's inside the users viewport",
													"gutenberg-aos"
											  )
											: __(
													"Don't animate Element when it's inside the users viewport",
													"gutenberg-aos"
											  )
									}
								/>
							...
							<PanelRow>
								<SelectControl
									...
									onChange={(gutenbergAOSAnimation) =>
										props.setAttributes({
