	...
	return (
		<div className={`wp-block-mm-bradentongulfislands-wideslideshow`}>
			{bannerTitle?.length > 0 && (
				<div className="wp-block-mm-bradentongulfislands-wideslideshow__banner-title">
					<h2>{bannerTitle}</h2>
				...
				<div className="bc-wrapper__items">
					<div className="bc-infoblock is-style-collage-square">
						<div className="bc-infoblock__content">
							<h2
								id="infoblock-title"
								className="infoblock__item infoblock__item--hide infoblock__item--green"
							>
								Slide Title
							</h2>
							<h3
								id="infoblock-info"
								className="infoblock__item infoblock__item--hide"
							>
								Slide Info
							</h3>
							<div
								id="infoblock-buttonurl"
								className="infoblock__item infoblock__item--hide"
							>
								<a
			...
			<div className={`swiper-thumbnail-preview-slider--thumbnails swiper`}>
				<div className={`swiper-wrapper bc-wrapper`}></div>
			</div>
		</div>
	);
};
