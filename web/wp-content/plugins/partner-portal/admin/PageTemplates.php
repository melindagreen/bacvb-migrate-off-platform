...
class PageTemplates {
    ...
    public function __construct() {
        ...
        $this->templates = array(
            '../partnerportal-theme-files/templates/partnerportal-listings.php' => 'PartnerPortal Listings Page',
        );
    }
    ...
    public function view_project_template( $template ) {
        ...
        if ( $post->post_type == Utilities::getPluginPostType() && is_singular() ) {
            $template = locate_template( array(  '/' . Constants::PLUGIN_THEME_DIR_SLUG . '/templates/partnerportal-single.php' ) );
        //check if this is a single 
            return $template;
            if ( !$template) {
                $file = plugin_dir_path( __FILE__ ).'../partnerportal-theme-files/templates/partnerportal-single.php';
        ...
        $template = locate_template( array( 'partnerportal-theme-files/templates/partnerportal-listings.php' ) );
