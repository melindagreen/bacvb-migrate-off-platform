...
namespace KrakenEvents\Compatibility\Admin;
...
require_once( KRAKEN_EVENTS_PLUGIN_DIR . 'inc/compat/eventastic-constants.php');
...
if (class_exists('Eventastic\Admin\SettingsAdminLayout')) {
    class_alias('Eventastic\Admin\SettingsAdminLayout', __NAMESPACE__ . '\LegacySettingsAdminLayout');
}

use KrakenEvents\Compatibility\Constants as Constants;
use KrakenEvents\Compatibility\LegacyUtilities as Utilities;

class LegacySettingsAdminLayout {
