...
if (class_exists('Eventastic\OpenCage\Geocoder\AbstractGeocoder')) {
    class_alias('Eventastic\OpenCage\Geocoder\AbstractGeocoder', __NAMESPACE__ . '\LegacyAbstractGeocoder');
}

abstract class LegacyAbstractGeocoder
{
    const TIMEOUT = 10;
