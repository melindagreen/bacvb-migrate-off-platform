<?php
/*
 Template Name: Eventastic Events Page (Kraken Events)
*/

use MaddenMedia\KrakenEvents\Utilities as U;

get_header();
global $post;
$meta = get_post_meta($post->ID);

$events = eventastic_get_events();
        ...
        <div class="events events-wrapper">
            ...
            if ( $events->found_posts > 0 ) :
                foreach($events->posts as $event):
                    ...
                    if ($recurring) {
                        $recurring_data_info = U::displayEventDates($post->ID);
                    }
            ...
            if ($eventCount > 20) echo '<div class="showMoreButton">Show More</div>'; ?>
        </div>
    </div>
</div>
<?php get_footer(); ?>