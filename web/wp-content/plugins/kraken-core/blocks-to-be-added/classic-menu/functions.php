...
class Madden_Classic_Menu_Walker extends \Walker_Nav_Menu {
  protected $block_attributes;
	...
	public function start_el( &$output, $data_object, $depth = 0, $args = null, $current_object_id = 0 ) {
		...
		if ($has_children) {
			$item_output .= '<button aria-label="Show submenu items" class="sub-menu-toggle"><svg width="19" height="10" viewBox="0 0 19 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L9 9" stroke-width="2" stroke-linecap="round"/><path d="M17.2929 1L9.29291 9" stroke-width="2" stroke-linecap="round"/></svg></button>';
		}
