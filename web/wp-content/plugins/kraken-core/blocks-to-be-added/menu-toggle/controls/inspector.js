			...
			<InspectorControls group="settings">
				<PanelBody title={__("Menu Toggle Settings", "madden-theme")}>
					<SelectControl
						...
						help={__(
							"Toggle will be displayed at selected breakpoint",
							"madden-theme"
						)}
					...
					/>
					<TextControl
						label={__("Menu Label", "madden-theme")}
						value={attributes.menuLabel}
						onChange={(value) => setAttributes({ menuLabel: value })}
					/>
					<TextControl
						label={__("Menu Target", "madden-theme")}
						help={__(
							"Add a target element to add .is-toggled to when active.",
							"madden-theme"
						)}
						value={attributes.menuTarget}
						onChange={(value) => setAttributes({ menuTarget: value })}
					/>
				</PanelBody>
			</InspectorControls>
