...
if ( is_admin() ) { return; }
if ( ! @file_exists( '/app/web/wp-content/plugins/breeze/breeze.php' ) ) { return; }
$config['config_path'] = '/app/web/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( '/app/web/wp-content/plugins/breeze/inc/cache/execute-cache.php' ) ) {
        include_once '/app/web/wp-content/plugins/breeze/inc/cache/execute-cache.php';
}